...
&kp TAB,           &kp Z,             &kp X,             &kp C,             &kp B,             &kp N,             &kp M,             &kp COMMA,         U_MT(RALT, DOT),   U_LT(U_BUTTON, SLASH),\
U_NP,              U_NP,              U_LT(U_MEDIA, ESC),&kp M,&kp SPACE,U_LT(U_MOUSE, SPACE),  U_LT(U_NUM, BSPC), &u_to_U_BASE,  U_NP,              U_NP
